...
<html>
	...
	<body class="overflow-hidden vh-100">
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container">
				<a class="navbar-brand" href="./login.jsp">Librería Honson - Editoriales</a>
	        ...
	        <div class="position-absolute top-50 start-50 translate-middle bg-light rounded-3 border p-3" style="min-width: 50vw;">
				...
				<table class="table table-striped ">
	                ...
	                <tbody>
		               		...
		               		<%
		    				ArrayList<Editorial> listaeditoriales = EditorialesControlador.getEditoriales();

			                for (int x = 0; x < listaeditoriales.size(); x++) {
								Editorial currentEditorial = listaeditoriales.get(x);
		                	%>
		                	
		                    <tr>
								<td><%=currentEditorial.getId() %></td>
								<td><%=currentEditorial.getNombre() %></td>
							</tr>
